...
- [[_COMMUNITY_Selective Forwarding Attack Runner|Selective Forwarding Attack Runner]]
- [[_COMMUNITY_DDoS Live Flood Evaluation|DDoS Live Flood Evaluation]]
- [[_COMMUNITY_DRAG Log Client (Off-chain)|DRAG Log Client (Off-chain)]]
- [[_COMMUNITY_Selective Forwarding Attack Core|Selective Forwarding Attack Core]]
- [[_COMMUNITY_LLM Service API Server|LLM Service API Server]]
- [[_COMMUNITY_Data Poisoning Attack|Data Poisoning Attack]]
- [[_COMMUNITY_Smart Contract Dependencies|Smart Contract Dependencies]]
- [[_COMMUNITY_SSM Score Attack & Defense|SSM Score Attack & Defense]]
- [[_COMMUNITY_Collate Functions (RoRA)|Collate Functions (RoRA)]]
- [[_COMMUNITY_Selective Forwarding Defense (Sim)|Selective Forwarding Defense (Sim)]]
- [[_COMMUNITY_On-chain Reliability Score Updates|On-chain Reliability Score Updates]]
- [[_COMMUNITY_Membership Inference Attack|Membership Inference Attack]]
- [[_COMMUNITY_DRAG Data Poisoning Demo|DRAG Data Poisoning Demo]]
- [[_COMMUNITY_Monte Carlo Shapley Base|Monte Carlo Shapley Base]]
- [[_COMMUNITY_MIA Defense Evaluator|MIA Defense Evaluator]]
- [[_COMMUNITY_MC-SHAP Model Wrappers|MC-SHAP Model Wrappers]]
- [[_COMMUNITY_SHAP Visualization|SHAP Visualization]]
- [[_COMMUNITY_DDoS Attack Simulation|DDoS Attack Simulation]]
- [[_COMMUNITY_MIA Decision-Match Scoring|MIA Decision-Match Scoring]]
- [[_COMMUNITY_DDoS & SFA Sim READMEs|DDoS & SFA Sim READMEs]]
- [[_COMMUNITY_MC-SHAP Embeddings & Init|MC-SHAP Embeddings & Init]]
- [[_COMMUNITY_On-chain Record Queries|On-chain Record Queries]]
- [[_COMMUNITY_Live Network Peers (SFA Sim)|Live Network Peers (SFA Sim)]]
- [[_COMMUNITY_Model Trainer|Model Trainer]]
- [[_COMMUNITY_On-chain Log Record Reads|On-chain Log Record Reads]]
- [[_COMMUNITY_DDoS Defense (Sim)|DDoS Defense (Sim)]]
- [[_COMMUNITY_MIA Weight Tuning|MIA Weight Tuning]]
- [[_COMMUNITY_MC-SHAP Text Splitters|MC-SHAP Text Splitters]]
- [[_COMMUNITY_Data Source Retriever (FAISS)|Data Source Retriever (FAISS)]]
- [[_COMMUNITY_LLM Service Configuration|LLM Service Configuration]]
- [[_COMMUNITY_Accuracy Metric|Accuracy Metric]]
- [[_COMMUNITY_Loss Metric|Loss Metric]]
- [[_COMMUNITY_Metric Base Class|Metric Base Class]]
- [[_COMMUNITY_HuggingFace Model Wrapper|HuggingFace Model Wrapper]]
- [[_COMMUNITY_Reranker (BM25 + Dense)|Reranker (BM25 + Dense)]]
- [[_COMMUNITY_DDoS Attack Runner|DDoS Attack Runner]]
- [[_COMMUNITY_SSM Vulnerability Report|SSM Vulnerability Report]]
- [[_COMMUNITY_System Architecture Diagram|System Architecture Diagram]]
- [[_COMMUNITY_SFA Attack (Sim)|SFA Attack (Sim)]]
- [[_COMMUNITY_Data Source API Server|Data Source API Server]]
- [[_COMMUNITY_Token-level SHAP Analysis|Token-level SHAP Analysis]]
- [[_COMMUNITY_LLM Service Tests|LLM Service Tests]]
- [[_COMMUNITY_Thesis CIA-Triad Framework|Thesis CIA-Triad Framework]]
- [[_COMMUNITY_SFA Sim Config & Runner|SFA Sim Config & Runner]]
- [[_COMMUNITY_OpenAI Embeddings (SHAP)|OpenAI Embeddings (SHAP)]]
- [[_COMMUNITY_SFA Sim Evaluation Runner|SFA Sim Evaluation Runner]]
- [[_COMMUNITY_Python Client (DragScores)|Python Client (DragScores)]]
- [[_COMMUNITY_Mock Network Simulation|Mock Network Simulation]]
- [[_COMMUNITY_Security Analysis Report (Unified)|Security Analysis Report (Unified)]]
- [[_COMMUNITY_KB & DDoS Report Findings|KB & DDoS Report Findings]]
- [[_COMMUNITY_KB Extraction Attack|KB Extraction Attack]]
- [[_COMMUNITY_MIA Attack Runner|MIA Attack Runner]]
- [[_COMMUNITY_DRAG vs Reliable-dRAG Context|DRAG vs Reliable-dRAG Context]]
- [[_COMMUNITY_Client Local Test Examples|Client Local Test Examples]]
- [[_COMMUNITY_Source Query & Signing|Source Query & Signing]]
- [[_COMMUNITY_Feedback Update Tests|Feedback Update Tests]]
- [[_COMMUNITY_Client Hardhat Utilities|Client Hardhat Utilities]]
- [[_COMMUNITY_DDoS Attack Report Findings|DDoS Attack Report Findings]]
- [[_COMMUNITY_MC-SHAP Splitter Base|MC-SHAP Splitter Base]]
- [[_COMMUNITY_vLLM Model Wrapper|vLLM Model Wrapper]]
- [[_COMMUNITY_RoRA Trainer|RoRA Trainer]]
- [[_COMMUNITY_MIAKB Evaluation Bugs|MIA/KB Evaluation Bugs]]
- [[_COMMUNITY_SSM Chain & Gray-hole Report|SSM Chain & Gray-hole Report]]
- [[_COMMUNITY_SFA Plotting Utility|SFA Plotting Utility]]
- [[_COMMUNITY_KB Defense & Data Source READMEs|KB Defense & Data Source READMEs]]
- [[_COMMUNITY_On-chain Score Record Creation|On-chain Score Record Creation]]
- [[_COMMUNITY_Contract Status Utilities|Contract Status Utilities]]
- [[_COMMUNITY_Reliability Score Screenshot|Reliability Score Screenshot]]
- [[_COMMUNITY_MIA Report Revision 7|MIA Report Revision 7]]
- [[_COMMUNITY_PubMedQA Corpus Builder|PubMedQA Corpus Builder]]
- [[_COMMUNITY_MIA Defense Runner|MIA Defense Runner]]
- [[_COMMUNITY_Contract Gas Tests|Contract Gas Tests]]
- [[_COMMUNITY_Data Source Service Tests|Data Source Service Tests]]
- [[_COMMUNITY_Result Curve Plotting|Result Curve Plotting]]
- [[_COMMUNITY_Defense Design Notes|Defense Design Notes]]
- [[_COMMUNITY_All-Services Test|All-Services Test]]
- [[_COMMUNITY_On-chain Score Updates (Batch)|On-chain Score Updates (Batch)]]
- [[_COMMUNITY_Reliability History Visualization|Reliability History Visualization]]
- [[_COMMUNITY_HTML Reports Index|HTML Reports Index]]
- [[_COMMUNITY_Contract Container Entrypoint|Contract Container Entrypoint]]
- [[_COMMUNITY_Contract Container Healthcheck|Contract Container Healthcheck]]
- [[_COMMUNITY_Python Client README|Python Client README]]
- [[_COMMUNITY_Client Full Test Script|Client Full Test Script]]
- [[_COMMUNITY_MIA Response Sanitization Notes|MIA Response Sanitization Notes]]
- [[_COMMUNITY_MIA Dataset Notes|MIA Dataset Notes]]
- [[_COMMUNITY_Contract Deployment Module|Contract Deployment Module]]
- [[_COMMUNITY_Data Source Docker Script|Data Source Docker Script]]
- [[_COMMUNITY_SFA Patch Script|SFA Patch Script]]
- [[_COMMUNITY_DDoS Sim Package Init|DDoS Sim Package Init]]
- [[_COMMUNITY_Live RAG Network Note|Live RAG Network Note]]
- [[_COMMUNITY_Mock RAG Network Note|Mock RAG Network Note]]
- [[_COMMUNITY_DDoS Overload Table Note|DDoS Overload Table Note]]
- [[_COMMUNITY_DDoS Wave Lifecycle Note|DDoS Wave Lifecycle Note]]
- [[_COMMUNITY_Attack Package Init|Attack Package Init]]
- [[_COMMUNITY_KB Extraction Package Init|KB Extraction Package Init]]
- [[_COMMUNITY_SFA Sim Package Init|SFA Sim Package Init]]
- [[_COMMUNITY_LivePeer Note|LivePeer Note]]
- [[_COMMUNITY_MockPeer Note|MockPeer Note]]
- [[_COMMUNITY_SSM Score Package Init|SSM Score Package Init]]
- [[_COMMUNITY_DDoS MockLive Mode Config|DDoS Mock/Live Mode Config]]
- [[_COMMUNITY_DDoS Defense Package Init|DDoS Defense Package Init]]
- [[_COMMUNITY_Defense Package Init|Defense Package Init]]
- [[_COMMUNITY_KB Defense Package Init|KB Defense Package Init]]
- [[_COMMUNITY_MIA Defense Package Init|MIA Defense Package Init]]
- [[_COMMUNITY_SFA Defense Package Init|SFA Defense Package Init]]
- [[_COMMUNITY_SFA Sim Defense Package Init|SFA Sim Defense Package Init]]
- [[_COMMUNITY_SSM Defense Package Init|SSM Defense Package Init]]
- [[_COMMUNITY_Hardhat Config|Hardhat Config]]
- [[_COMMUNITY_Data Source App Init|Data Source App Init]]
- [[_COMMUNITY_Data Source Src Init|Data Source Src Init]]
- [[_COMMUNITY_Retriever Package Init|Retriever Package Init]]
- [[_COMMUNITY_Data Source Utils Init|Data Source Utils Init]]
- [[_COMMUNITY_LLM Service App Init|LLM Service App Init]]
- [[_COMMUNITY_LLM Service Src Init|LLM Service Src Init]]
- [[_COMMUNITY_Metrics Package Init|Metrics Package Init]]
- [[_COMMUNITY_Models Package Init|Models Package Init]]
- [[_COMMUNITY_Retriever Package Init (LLM Svc)|Retriever Package Init (LLM Svc)]]
- [[_COMMUNITY_Utils Package Init|Utils Package Init]]
- [[_COMMUNITY_Framework LLM Service Node|Framework LLM Service Node]]
...
Cohesion: 0.06
Nodes (56): _answer_in_context(), _apply_attack(), _build_real_sources(), chain_length(), check_blockchain_status(), _check_sources_reachable(), _detector_observe(), _detector_report() (+48 more)
...
Cohesion: 0.07
Nodes (41): _FakeReranker, _make_candidates(), _make_orthogonal_like_embeddings(), drag_llm_service/test_similarity_noise_defense.py  Unit tests for the similarity, select_top_k_with_defense with similarity_noise_enabled absent/false must     pr, Sanity check on the epsilon -> scale relationship (b = sensitivity/epsilon):, With a tiny epsilon (huge noise) on two near-tied candidates, the     resulting, Same base seed, different query text -> different derived sub-seed ->     differ (+33 more)

### Community 11 - "Membership Inference Attack"
Cohesion: 0.04
Nodes (44): API Endpoints, Architecture, Building and Running, code:bash (docker-compose up --build -d), code:bash (curl -X POST http://localhost:8001/query \), code:json ({), code:bash (python test_service.py http://localhost:8001), code:bash (python test_all_services.py) (+36 more)
...
Cohesion: 0.5
Nodes (4): Reranker Settings (hybrid, all-MiniLM-L6-v2), Retrieval & Reranking Settings, Hybrid Reliability-Weighted Reranker, drag_llm_service Python dependencies (Flask, sentence-transformers, web3, etc.)
