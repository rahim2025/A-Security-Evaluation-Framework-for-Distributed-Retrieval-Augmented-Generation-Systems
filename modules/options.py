...
def parse_args():
    ...
    parser.add_argument("--security.target_peer_ids", type=list[int])
    parser.add_argument("--security.amplification_factor", type=int)
    parser.add_argument("--security.question_variants", type=int)
    ...
    parser.add_argument("--security.extraction_use_dataset_questions", type=bool)
    ...
    parser.add_argument("--security.enable_selective_forwarding", type=bool)
    parser.add_argument("--security.sfa_ratio", type=float)
    parser.add_argument("--security.sfa_strategy", type=str)

    # Routing Manipulation Attack
    parser.add_argument("--security.enable_routing_manipulation", type=bool, default=False)
    parser.add_argument("--security.routing_attacker_peer", type=int)
    parser.add_argument("--security.routing_attacker_ratio", type=float, default=0.1)
    parser.add_argument("--security.routing_attack_strategy", type=str, default="random")
    parser.add_argument("--security.routing_response_type", type=str, default="fabricated")
    parser.add_argument("--security.routing_topic_claim_ratio", type=float, default=1.0)
    ...
    # Privacy-Preserving Retrieval defense (against Membership Inference Attack)
    parser.add_argument("--defense.privacy_preserving_retrieval.enabled", type=bool, default=False)
    parser.add_argument("--defense.privacy_preserving_retrieval.noise_mechanism", type=str, default="laplace")
    parser.add_argument("--defense.privacy_preserving_retrieval.noise_scale", type=float, default=0.1)
